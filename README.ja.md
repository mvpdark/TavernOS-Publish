...
| | ライター Writer | スタイル指紋 + 9 層コンテキスト注入による生成 |
| | 監査 Auditor | 連続性チェック、フック密度、中国語数字フォーマット |
| | 改訂 Reviser | 監査フィードバックに基づく的確な改訂 |
...
> [Releases](https://github.com/mvpdark/TavernOS-Publish/releases) から `TavernOS-Setup-x.x.x-x64.exe` をダウンロードしてください。自動更新チェックを内蔵しています。
...
<p align="center">
  <sub><i>酒館システム · TavernOS</i></sub><br/>
