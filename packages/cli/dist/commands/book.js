...
import { resolveCliContext, resolveBookId, listBookIds, loadBookMeta, saveBookConfig, bookDir, ensureDir, info, success, CHAPTERS_DIR, STORY_DIR, } from "../context.js";
// ---------------------------------------------------------------------------
...
// book create
// ---------------------------------------------------------------------------
async function runBookCreate(title, opts) {
    ...
    const config = {
        ...
        language: opts.language ?? ctx.config.language,
        createdAt: now,
        updatedAt: now,
...
// book info
// ---------------------------------------------------------------------------
async function runBookInfo(bookId) {
    const ctx = await resolveCliContext();
