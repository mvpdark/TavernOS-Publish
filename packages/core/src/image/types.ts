...
// ---------------------------------------------------------------------------
// Image provider configs (parallel to the LLM PROVIDER_CONFIGS)
// ---------------------------------------------------------------------------
...
export const IMAGE_PROVIDER_CONFIGS: ReadonlyArray<ImageProviderConfig> = [
  {
    id: "dalle",
    name: "OpenAI DALL-E",
...
export class ImageProviderRegistry {
  private readonly table: ReadonlyMap<string, ImageProviderConfig>;
...
export const imageProviderRegistry: ImageProviderRegistry = new ImageProviderRegistry(
