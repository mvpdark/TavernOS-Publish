...
// Factory
// ---------------------------------------------------------------------------
export function createTTSClient(config) {
...
// ---------------------------------------------------------------------------
async function synthesizeSpeech(config, baseUrl, model, defaultVoice, apiPattern, request) {
 ...
 */
function decodeAudioString(str) {
